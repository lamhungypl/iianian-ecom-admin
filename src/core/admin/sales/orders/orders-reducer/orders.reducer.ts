...
export const getOrderDeleteLoading = (state: SalesOrderState) => state.orderDeleteLoading;
export const getOrderDeleteLoaded = (state: SalesOrderState) => state.orderDeleteLoaded;
export const getOrderDeleteFailed = (state: SalesOrderState) => state.orderDeleteFailed;
export const getorderDeleteValue = (state: SalesOrderState) => state.orderDeleteValue;
