...
export const getbannerListCountLoaded = (state: BannerState) => state.bannerListCountLoaded;
export const getbannerListCountFailed = (state: BannerState) => state.bannerListCountFailed;
export const getbannerListCountLoading = (state: BannerState) => state.bannerListCountLoading;

export const getbannerListActive = (state: BannerState) => state.bannerListActive;
export const getbannerListActiveLoaded = (state: BannerState) => state.bannerListActiveLoaded;
export const getbannerListACtiveFailed = (state: BannerState) => state.bannerListACtiveFailed;
export const getbannerListActiveLoading = (state: BannerState) => state.bannerListActiveLoading;

export const getbannerListInActive = (state: BannerState) => state.bannerListInActive;
export const getbannerListInActiveLoaded = (state: BannerState) => state.bannerListInActiveLoaded;
export const getbannerListInACtiveFailed = (state: BannerState) => state.bannerListInACtiveFailed;
export const getbannerListInActiveLoading = (state: BannerState) => state.bannerListInActiveLoading;
