...
export const getbannerListCount = createSelector(getBannerState, frombanner.getbannerListCount);
export const getbannerListCountLoaded = createSelector(getBannerState, frombanner.getbannerListCountLoaded);
export const getbannerListCountFailed = createSelector(getBannerState, frombanner.getbannerListCountFailed);
export const getbannerListCountLoading = createSelector(getBannerState, frombanner.getbannerListCountLoading);

export const getbannerListActive = createSelector(getBannerState, frombanner.getbannerListActive);
export const getbannerListActiveLoaded = createSelector(getBannerState, frombanner.getbannerListActiveLoaded);
export const getbannerListACtiveFailed = createSelector(getBannerState, frombanner.getbannerListACtiveFailed);
export const getbannerListActiveLoading = createSelector(getBannerState, frombanner.getbannerListActiveLoading);

export const getbannerListInActive = createSelector(getBannerState, frombanner.getbannerListInActive);
export const getbannerListInActiveLoaded = createSelector(getBannerState, frombanner.getbannerListInActiveLoaded);
export const getbannerListInACtiveFailed = createSelector(getBannerState, frombanner.getbannerListInACtiveFailed);
export const getbannerListInActiveLoading = createSelector(getBannerState, frombanner.getbannerListInActiveLoading);
