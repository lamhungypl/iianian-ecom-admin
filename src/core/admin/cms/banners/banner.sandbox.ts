...
export class BannerSandbox implements OnDestroy {
  ...
  public getbannerListCountLoaded$ = this.appState.select(getbannerListCountLoaded);
  public getbannerListCountFailed$ = this.appState.select(getbannerListCountFailed);
  public getbannerListCountLoading$ = this.appState.select(getbannerListCountLoading);

  public getbannerListActive$ = this.appState.select(getbannerListActive);
  public getbannerListActiveLoaded$ = this.appState.select(getbannerListActiveLoaded);
  public getbannerListACtiveFailed$ = this.appState.select(getbannerListACtiveFailed);
  public getbannerListActiveLoading$ = this.appState.select(getbannerListActiveLoading);

  public getbannerListInActive$ = this.appState.select(getbannerListInActive);
  public getbannerListInActiveLoaded$ = this.appState.select(getbannerListInActiveLoaded);
  public getbannerListInACtiveFailed$ = this.appState.select(getbannerListInACtiveFailed);
  public getbannerListInActiveLoading$ = this.appState.select(getbannerListInActiveLoading);
