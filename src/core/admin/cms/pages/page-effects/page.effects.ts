...
export class PageEffects {
  ...
  doPagesCountList$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      return this.apiCli.getpageslist(state).pipe(
        switchMap(pagesCount => [new actions.DoPagescountSuccessAction(new PagescountResponseModel(pagesCount))]),
  ...
  activePageCount$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      return this.apiCli.getpageslist(state).pipe(
        switchMap(pagesCount => [new actions.GetActiveCountSuccess(new PagescountResponseModel(pagesCount))]),
  ...
  in_activePageCount$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      return this.apiCli.getpageslist(state).pipe(
        switchMap(pagesCount => [new actions.GetInactiveCountSuccess(new PagescountResponseModel(pagesCount))]),
