  ...
  public subscribe() {
    ...
    this.getCategoriesList$.subscribe(data => {
      _.each(data, value => {
        ...
        params.subLevel2 = _.get(value, 'levels[1].categoryName') ? ' > ' + _.get(value, 'levels[1].categoryName') : '';
        params.subLevel3 = _.get(value, 'levels[2].categoryName') ? ' > ' + _.get(value, 'levels[2].categoryName') : '';
