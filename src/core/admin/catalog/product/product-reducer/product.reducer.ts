...
// getting option list
export const gettingOptionList = (state: ProductState) => state.gettingoptionList;
export const gettingOptionListLoading = (state: ProductState) => state.gettingOptionLoading;
export const gettingOptionListLoaded = (state: ProductState) => state.gettingOptionLoaded;
export const gettingOptionListFailed = (state: ProductState) => state.gettingOptionFailed;
// product Bulk Delete

export const getProductBulkDelete = (state: ProductState) => state.productBulkDelete;
