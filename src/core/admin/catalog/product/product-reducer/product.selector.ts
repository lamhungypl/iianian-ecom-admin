...
// getting option list
export const gettingOptionList = createSelector(getProdState, fromProduct.gettingOptionList);
export const gettingOptionListLoading = createSelector(getProdState, fromProduct.gettingOptionListLoading);
export const gettingOptionListLoaded = createSelector(getProdState, fromProduct.gettingOptionListLoaded);
export const gettingOptionListFailed = createSelector(getProdState, fromProduct.gettingOptionListFailed);
// product Bulk Delete

export const getProdBulkDelete = createSelector(getProdState, fromProduct.getProductBulkDelete);
