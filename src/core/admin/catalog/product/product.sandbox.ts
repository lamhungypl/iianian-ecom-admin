...
export class ProductSandbox {
  ...
  public gettingOptionListLoading$ = this.appState.select(gettingOptionListLoading);
  public gettingOptionListLoaded$ = this.appState.select(gettingOptionListLoaded);
  public gettingOptionListFailed$ = this.appState.select(gettingOptionListFailed);
