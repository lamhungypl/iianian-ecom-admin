...
export const getFeaturedProductCountLoaded = createSelector(
  getCatalogLayoutState,
  fromDashboard.getFeaturedProductCountLoaded
);
export const getFeaturedProductCountLoading = createSelector(
  getCatalogLayoutState,
  fromDashboard.getFeaturedProductCountLoading
);
export const getFeaturedProductCountFailed = createSelector(
  getCatalogLayoutState,
  fromDashboard.getFeaturedProductCountFailed
);
