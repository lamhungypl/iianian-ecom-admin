  ...
  doLanguagelists$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      return this.service.Languageslist(state).pipe(
        switchMap(language => [new actions.DoLanguageListSuccessAction(language)]),
  ...
  doLanguageAdds$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      return this.service.ADDLanguage(state).pipe(
        switchMap(language => [new actions.DoAddLanguageSuccessAction(language)]),
  ...
  doLanguageUpdate$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      ...
      return this.service.UpdateLanguage(state, languageId).pipe(
        switchMap(language => [new actions.DoUpdateLanguageSuccessAction(language)]),
  ...
  doLanguageDelete$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      ...
      return this.service.DeleteLanguage(state, languageId).pipe(
        switchMap(language => [new actions.DoDeleteLanguageSuccessAction(language)]),
  ...
  doLanguagelistspagination$: Observable<Action> = this.action$.pipe(
    ...
    switchMap(state => {
      return this.service.Languageslistpagination(state).pipe(
        switchMap(language => [new actions.DoLanguagePaginationSuccessAction(language)]),
