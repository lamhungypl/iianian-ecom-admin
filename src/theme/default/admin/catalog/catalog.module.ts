...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    EffectsModule.forRoot([LayoutEffects, CategoriesEffect, BrandEffects, ProductEffect]),
    CKEditorModule,
  ],
  providers: [LayoutService, LayoutsSandbox, BrandApiClient, BrandSandbox, CategoriesService, ProductService],
  bootstrap: [],
  entryComponents: [],
})
